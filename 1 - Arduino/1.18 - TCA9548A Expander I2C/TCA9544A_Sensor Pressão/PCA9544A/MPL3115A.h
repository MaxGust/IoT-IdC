/*****************************************************************
* MPL3115A Pressure Sensor Library
*
*****************************************************************/

#define MPL         0x60  // MPL3115A2 I2C Address

byte IIC_Read(byte regAddr);
void IIC_Write(byte regAddr, byte value);
void sensor_config(void);
void sensor_read_data(void);
boolean check_new(void);
...
byte IIC_Read(byte regAddr)
{
  ...
  Wire.endTransmission(false); // Send data to I2C dev with option
                               ...
                               // Arduino V1.0.1!!!!!!!!!
  Wire.requestFrom(MPL, 1); // Request the data...
  return Wire.read();
}
